...
export default function Cart() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/cart/cart/${decodedData.id}`).then((res) => {
    ...
    //   delete
      const deleteProduct = (e,_id) => {
        e.preventDefault()
        console.log(_id)
        axios.delete(`http://localhost:3001/cart/cart/delete/${decodedData.id}/${_id}`).then((response) => {
      ...
      if (loading) { 
      return (<div classNameNameNameNameName="spinner-border text-danger" role="status">
        ...
        <div classNameNameNameName="col-md-12">
            <div classNameNameNameName="card">
                ...
                <div classNameNameNameName="card-body cart">
                    <div classNameNameNameName="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" classNameNameNameName="img-fluid mb-4 mr-3"/>
                        <h3><strong>Your Cart is Empty</strong></h3>
                        <h4>Add something to make me happy :)</h4> <a href="#" classNameNameNameName="btn btn-primary cart-btn-transform m-3" data-abc="true">continue shopping</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <ul className="cart_list">
                            <li className="cart_item clearfix">
                                <div className="cart_item_image"><img src={item.products.image} alt=""/></div>
                                <div className="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    <div className="cart_item_name cart_info_col">
                                        <div className="cart_item_title">Name</div>
                                        <div className="cart_item_text">{item.products.nameProduct}</div>
                                    </div>
                                    ...
                                    <div className="cart_item_price cart_info_col">
                                        ...
                                        <div className="cart_item_text">{item.products.price}</div>
                                    </div>
